let DATA = [
    { user: "timmy", message: "삶이 있는 한 희망은 있다.", created_at: "1999-03-12 00:00:00" },
    { user: "sam", message: "산다는것 그것은 치열한 전투이다.", created_at: "1990-08-24 15:24:12" },
    { user: "jason", message: "하루에 3시간을 걸으면 7년 후에 지구를 한바퀴 돌 수 있다.", created_at: "1995-04-12 07:07:07" },
    { user: "karl", message: "언제나 현재에 집중할수 있다면 행복할것이다.", created_at: "1875-07-16 12:34:56" },
    { user: "lemon", message: "진정으로 웃으려면 고통을 참아야하며 , 나아가 고통을 즐길 줄 알아야 해.", created_at: "1932-03-12 00:00:00" },
];
...
function generateNewTweet() {
    var tweet = {};
    tweet.user = namea[getRandomInt(0, namea.length)];
    tweet.message = message[getRandomInt(0, message.length)];
